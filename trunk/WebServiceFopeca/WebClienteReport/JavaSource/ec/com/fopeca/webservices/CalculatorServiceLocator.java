...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements ec.com.fopeca.webservices.CalculatorService {
    ...
    private java.lang.String CalculatorPort_address =Constantes.get_URLREMOTO()+ "/WebReport/Calculator";
    ...
    public ec.com.fopeca.webservices.CalculatorWs getCalculatorPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ec.com.fopeca.webservices.CalculatorServiceSoapBindingStub _stub = new ec.com.fopeca.webservices.CalculatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ec.com.fopeca.webservices.CalculatorWs.class.isAssignableFrom(serviceEndpointInterface)) {
                ec.com.fopeca.webservices.CalculatorServiceSoapBindingStub _stub = new ec.com.fopeca.webservices.CalculatorServiceSoapBindingStub(new java.net.URL(CalculatorPort_address), this);
                _stub.setPortName(getCalculatorPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.fopeca.com.ec/", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.fopeca.com.ec/", "CalculatorPort"));
        }
